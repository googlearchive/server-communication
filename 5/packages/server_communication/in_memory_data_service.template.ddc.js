define(['dart_sdk', 'packages/angular/src/di/reflector', 'packages/server_communication/in_memory_data_service', 'packages/angular/angular.template', 'packages/server_communication/src/toh/hero.template'], function(dart_sdk, reflector, in_memory_data_service, angular, hero) {
  'use strict';
  ...
  dart.trackLibraries("packages/server_communication/in_memory_data_service.template.ddc", {
    "package:server_communication/in_memory_data_service.template.dart": in_memory_data_service$46template
  }, '{"version":3,"sourceRoot":"","sources":["in_memory_data_service.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;MAkBI,0CAAQ;YAAG;;;;;AAEb,kBAAI,0CAAQ,GAAE;AACZ;;AAEF,iDAAW;AAEX,IAAO,kCAAe,CAAC,0DAAmB,EAAE,cAAM,IAAI,+CAAmB;AACzE,IAAM,gCAAa;AACnB,IAAM,uCAAa;EACrB","file":"in_memory_data_service.template.ddc.js"}');
  // Exports:
  return {
